...
EOF;
    ...
    if ($post["subject"] != "") {
        $return .= '<a href="?do=thread&id='.$post["id"].'">';       
	}
	if ($post["subject"] != "") {
        $return .= "  <span class=\"filetitle\">${post["subject"]}<br><br></span> ";       
	}
    if ($post["subject"] != "") {
        $return .= '</a>';       
	}
...
function buildPage($htmlposts, $parent, $pages=0, $thispage=0) {
	...
	$body = '
	<a href="?"><body onLoad="onFirstLoad();">
		<div class="logo">
'.TINYIB_LOGO.'
		</div>
        </a>
        ...
        <body>
        <br>
        <a href="https://blog.somchan.ml" style="text-decoration: none;">
        <span class="links">
            &nbsp;blog
        </span>
        </a>  
        &nbsp;
        <a href="https://blog.somchan.ml/help.html" style="text-decoration: none;">
        <span class="links">
            &nbsp;help
        </span>
        </a>
        &nbsp;
        <a href="https://somchan.ml" style="text-decoration: none;">
        <span class="links">
            &nbsp;somchan&nbsp;
        </span>
        </a>
